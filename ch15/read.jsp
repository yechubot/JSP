...
<%
	  ...
	  bMgr.upCount(num);//조회수 증가(한번 찍고 온거니까)
	  BoardBean bean = bMgr.getBoard(num);//해당 번호 게시물 내용 몽땅 가져와서 bean에 넣음  
	  ...
	  //bean을 세션에 저장
	  //나중에 getsesstion으로 bean으로 가져올 수 있게
%>
<html>
<head>
...
<script type="text/javascript">
	...
	function down(filename){
		 ...
		 document.downFrm.submit();//download.jsp 부름
	}
</script>
</head>
<body bgcolor="#FFFFCC">
